...
class ScoreBottomDialogue(
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.rateStar2.setOnClickListener {
            rateAnime(2)
            binding.rateStar1.setImageResource(R.drawable.ic_star2_selected)
        }
        binding.rateStar3.setOnClickListener {
            rateAnime(3)
            binding.rateStar1.setImageResource(R.drawable.ic_star3_selected)
        }
        binding.rateStar4.setOnClickListener {
            rateAnime(4)
            binding.rateStar1.setImageResource(R.drawable.ic_star4_selected)
        }
        binding.rateStar5.setOnClickListener {
            rateAnime(5)
            binding.rateStar1.setImageResource(R.drawable.ic_star5_selected)
        }
    }
}