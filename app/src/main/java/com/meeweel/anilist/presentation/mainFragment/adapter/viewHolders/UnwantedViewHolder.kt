...
class UnwantedViewHolder(
    ...
    private val binding: UnwantedRecyclerItemBinding = UnwantedRecyclerItemBinding.inflate(
    ...
    override fun bind(anime: ShortAnime) {
        binding.apply {
            val circularProgressDrawable =
                CircularProgressDrawable(this.unwantedFragmentRecyclerItemImageView.context)
            ...
            Glide.with(this.unwantedFragmentRecyclerItemImageView.context).load(anime.image)
