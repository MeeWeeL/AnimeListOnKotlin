...
class WatchedViewHolder(
    ...
    private val binding: WatchedRecyclerItemBinding = WatchedRecyclerItemBinding.inflate(
    ...
    override fun bind(anime: ShortAnime) {
        binding.apply {
            val circularProgressDrawable =
                CircularProgressDrawable(this.watchedFragmentRecyclerItemImageView.context)
            ...
            Glide.with(this.watchedFragmentRecyclerItemImageView.context).load(anime.image)
