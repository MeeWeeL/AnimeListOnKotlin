...
class WantedFragment(private val router: CustomRouter = appRouter) : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        adapter.setOnLongItemViewClickListener(object : WantedFragment.OnLongItemViewClickListener {
        ...
        viewModel.getWantedAnimeFromLocalSource()
    }
    ...
    private fun showPopupMenu(anime: ShortAnime, view: View, position: Int) {
        ...
        popupMenu.inflate(R.menu.wanted_popup_menu)
